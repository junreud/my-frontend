...
const CompanyStats = () => {
  const [stats] = useState([
    { value: 1000, target: 1000, label: "활성 고객사", suffix: "+", icon: "👥" },
    { value: 150, target: 150, label: "평균 성과 향상", suffix: "%", icon: "📈" },
    { value: 50, target: 50, label: "전문 파트너사", suffix: "+", icon: "🤝" },
    { value: 99, target: 99, label: "고객 만족도", suffix: "%", icon: "⭐" }
  ]);
